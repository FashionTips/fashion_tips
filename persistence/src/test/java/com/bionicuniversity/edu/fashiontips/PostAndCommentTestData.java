...
public class PostAndCommentTestData {
    ...
    public static final Comment UPDATE_COMMENT2 = new Comment(2L, "UpdateFromTest", POST2, USER1, LocalDateTime.of(2015, Month.DECEMBER, 17, 12, 1));

    public static final Comment NEW_COMMENT_BEFORE_SAVE = new Comment(null, "terrible hat!!!", POST3, USER2, LocalDateTime.of(2015, Month.DECEMBER, 17, 13, 2));
    public static final Comment NEW_COMMENT_AFTER_SAVE = new Comment(4L, "terrible hat!!!", POST3, USER2, LocalDateTime.of(2015, Month.DECEMBER, 17, 13, 2));

    public static final List<Comment> LIST_OF_COMMENTS = Arrays.asList(COMMENT1, COMMENT2, COMMENT3);
    public static final List<Comment> LIST_WITH_NEW_COMMENT = Arrays.asList(COMMENT1, COMMENT2, COMMENT3, NEW_COMMENT_AFTER_SAVE);
