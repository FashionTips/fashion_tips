...
public class CommentTestData {
    ...
    public static final Comment comment1 = new Comment("cool!", post1);
    public static final Comment comment2 = new Comment("amazing!!", post2);
    public static final Comment comment3= new Comment("perfect!!!", post3);
    public static final Comment comment4= new Comment("perfect!!!", post3);
