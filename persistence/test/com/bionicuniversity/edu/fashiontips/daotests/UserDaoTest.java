...
@Sql(scripts = {"classpath:db/initPostgresDB.sql","classpath:db/filloutDB.sql"},
        executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD,
        config = @SqlConfig(encoding = "UTF-8"))
public class UserDaoTest {
    private static User user1 = new User("login4", "email4@example.com", "1111");
    private static Post post1 = new Post(user1, "How my glasses fits me?", Category.QUESTION);
    private static User user2 = new User("login1", "email1@example.com", "1111");
    private static Post post2 = new Post(user2, "what fits me with these pants?", Category.QUESTION);
    static {
        user1.setId(4L);
        user2.setId(1L);
    }
    ...
    public void testGetPostsOfUser() {
        ...
        Post post1 = new Post(user2, "what fits me with these pants?", Category.QUESTION);
        Post post2 = new Post(user2, "what fits me with these pants? Again", Category.POST);
